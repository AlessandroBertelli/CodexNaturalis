...
/**
 * Test class for the AbstractDeck class. It contains unit tests to verify the functionality
 * of various methods in the AbstractDeck class.
 */
public class AbstractDeckTest {

    private AbstractDeck emptyDeck;
    private AbstractDeck filledDeck;
    ...
    /**
     * Inner class that extends AbstractDeck for testing purposes.
     */
    private class TestDeck extends AbstractDeck {
        public TestDeck(List<AbstractCard> cards, int maxSize) {
            super(cards, maxSize);
        }

        public TestDeck(int maxSize) {
            super(maxSize);
        }
    }
    ...
    public void setUp() {
        ...
        emptyDeck = new TestDeck(20);
        filledDeck = new TestDeck(cards, 20);
    }
    ...
    public void testAddCardToFullDeck() {
        AbstractDeck fullDeck = new TestDeck(cards, 10);
        AbstractCard newCard = cards.get(0);
