...
/**
 * Test class for the DeckTarget class. It contains unit tests to verify the functionality
 * of various methods in the DeckTarget class.
 */
public class DeckTargetTest {

    private DeckTarget emptyDeck;
    private DeckTarget filledDeck;
    ...
    public void setUp() {
        ...
        emptyDeck = new DeckTarget(20);
        filledDeck = new DeckTarget(cards, 20);
    }
    ...
    public void testAddCardToFullDeck() {
        AbstractDeck fullDeck = new DeckTarget(cards, 10);
        AbstractCard newCard = cards.get(0);
    ...
    public void testShuffleDeck() {
        ...
        // Checks if all the original cards are still present
